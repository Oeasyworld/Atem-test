...
const updateUser = (ListingImage,isUser)=>{
 
   let userId = isUser?authorId:buyerId;
  const parameters ={
    id: userId,
  ...
  integrationSdk.users.show(
    ...
    //console.log(firstName+"  "+lastName+"  "+profileImage+"  "+ListingImage+"  "+isUser+"    555555555555555555555555555555555555555555 ");
    ...
    updateUserProfileData(currentListing,firstName,lastName,profileImage,ListingImage,isUser,currentReviews);
   
  })

  const updateUserProfileData = (currentListings,firstName,lastName,profileImage,listingPhoto,isUser,currentReviews)=>{
    
    //New listing to be added
    const listingDetails = isUser? {
      refId:refId,
    ...
    //compile user data
    const id = isUser? buyerId:authorId;
