...
import { updateProfileTransactionAcceptAgreement, updateProfileTransactionAgreement,getFreelancerToBePaidByUser } from '../TransactionPage/TransactionPage.duck.js';
...
export const ListingPageComponent = props => {
  ...
  const {
    ...
    onAccept,
    onCancelAgree,
    callGetFreelancerToBePaidByUser,
    reviews
  } = props;
  ...
  //Get information about Freelancer to be paid if available
...
const getAcceptedAgreement = (agreements,agreementToCheckForAcceptance) => {
  ...
  if(currentUser !== undefined && currentUser !== null ){
    ...
    // if(alternateListingUsersPayToId !== undefined){
    //   listingId.uuid = alternateListingUsersPayToId;
    // }
  ...
  //authorDisplayName = influencerToBePaidDisplayName && role === "User"?influencerToBePaidDisplayName:authorDisplayName;
...
const mapDispatchToProps = dispatch => ({
  ...
  onFetchTimeSlots: (listingId, start, end, timeZone) =>
    ...
    callGetFreelancerToBePaidByUser:(id) => dispatch(getFreelancerToBePaidByUser(id)),
});
