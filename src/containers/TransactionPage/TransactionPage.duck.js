...
export const getFreelancerToBePaidByUser = userId => (dispatch, getState, sdk) => {
  return sdk.users
    .show({
      id: userId,
...
export const updateProfileTransactionAgreement = data => (dispatch, getState, sdk) => {
  ...
  //Copy the original Listing to be used by Freelancer to receive payment for User's Listing
  ...
  sdk.ownListings.create({
    ...
    data.alternateListingUsersPayToId = respons.data.data.id.uuid;
